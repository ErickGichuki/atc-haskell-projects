...
|                      | Use of Haskell best practices              | 10         | 6 (ensure state is valid at all time, use domain driven design, make sure you understand the code you write)         |
| **Total**            | *(100 points if advanced features are not implemented, 120 if they are)* | **100** | **98** |
